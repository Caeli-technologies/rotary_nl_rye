...
List<YearList> yearList = [
  ...
  // Exchange Year 2020-2020
  YearList(
    title: 'Exchange Year 2020-2020',
    year: '2020-2020',
    list: studentsList_2020_2020,
    icon: FontAwesomeIcons.passport,
  ),
  ...
  // Exchange Year 2019-2019
  YearList(
    title: 'Exchange Year 2019-2019',
    year: '2019-2019',
    list: studentsList_2019_2019,
    icon: FontAwesomeIcons.passport,
  ),
