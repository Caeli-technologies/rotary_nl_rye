        ...
        children: <Widget>[
          Column(
            ...
            children: <Widget>[
              buildIntroText(),
              SizedBox(height: 40),
              buildSectionTitle('Long Term Exchange Program'),
              ...
              SizedBox(height: 10),
              buildSectionTitle('Short Term Exchange Program'),
              Divider(height: 15, thickness: 2),
              buildProgramOptionRow(
                context,
                'NGSE',
  ...
  Widget buildIntroText() {
    return Padding(
      ...
      child: Text(
        ...
        'Wereldwijd gaan er jaarlijks zo\'n 8.000 studenten via Rotary op uitwisseling, een hele organisatie. '
        'Wie weet ben jij komend schooljaar een van die studenten.',
