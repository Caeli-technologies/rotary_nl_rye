...
const InfoSection = React.memo(
	({ title, content, styles, themeColors }: InfoSectionProps) => {
		return (
			<View
				style={[
					styles.infoSection,
			...
			>
				...
				<Text
					style={[styles.sectionContent, { color: themeColors.textSecondary }]}
				>
					{content}
				</Text>
			</View>
