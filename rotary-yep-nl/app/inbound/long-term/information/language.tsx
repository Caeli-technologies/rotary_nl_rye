        ...
        <View style={styles.content}>
          ...
          <View style={styles.headerSection}>
            <View style={[styles.headerIcon, { backgroundColor: themeColors.primary + '15' }]}>
              <Ionicons name="chatbubble-outline" size={32} color={themeColors.primary} />
            </View>
          ...
          <View style={styles.section}>
            <View
              ...
              <View style={styles.challengeHeader}>
                <Ionicons name="trending-up-outline" size={24} color={themeColors.secondary} />
            ...
            <View
              ...
              <View style={styles.docDetails}>
                <View style={styles.docItem}>
                  <Ionicons name="calendar-outline" size={16} color={themeColors.info} />
                ...
                <View style={styles.docItem}>
                  <Ionicons name="people-outline" size={16} color={themeColors.info} />
                  <Text style={[styles.docText, { color: themeColors.text }]}>
                    Small groups with fellow exchange students
                  </Text>
                </View>
                <View style={styles.docItem}>
                  <Ionicons name="globe-outline" size={16} color={themeColors.info} />
                  <Text style={[styles.docText, { color: themeColors.text }]}>
              ...
              <Text
                style={[
                  styles.docNote,
                  { color: themeColors.primary, borderTopColor: themeColors.border },
                ]}>
          ...
          <View style={styles.section}>
            ...
            <View
              ...
              <View style={styles.supportHeader}>
                <Ionicons name="heart-outline" size={20} color={themeColors.success} />
