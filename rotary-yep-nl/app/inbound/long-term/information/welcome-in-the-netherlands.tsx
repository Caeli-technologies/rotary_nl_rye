        ...
        <View style={styles.content}>
          ...
          <View style={styles.section}>
            <View style={styles.sectionHeader}>
              ...
              <Text style={[styles.sectionTitle, { color: themeColors.text }]}>Our Community</Text>
            </View>
            ...
            <View
              ...
              <View style={[styles.highlightBox, { backgroundColor: themeColors.accent + '15' }]}>
              ...
              <View style={[styles.friendsBox, { backgroundColor: themeColors.secondary + '15' }]}>
                <Ionicons name="heart-outline" size={16} color={themeColors.secondary} />
                <Text style={[styles.friendsText, { color: themeColors.textSecondary }]}>
          ...
          <View style={styles.section}>
            ...
            <View
              ...
              <View style={styles.experienceHeader}>
                <Ionicons name="sparkles-outline" size={20} color={themeColors.secondary} />
                <Text style={[styles.experienceSubtitle, { color: themeColors.text }]}>
          ...
          <View style={styles.section}>
            <View
              ...
              <View style={styles.ambassadorHeader}>
                <Ionicons name="ribbon-outline" size={24} color={themeColors.primary} />
                <Text style={[styles.ambassadorTitle, { color: themeColors.text }]}>
                  Ambassador Role
                </Text>
              </View>
              <Text style={[styles.ambassadorText, { color: themeColors.textSecondary }]}>
          ...
          <View style={styles.section}>
            <View style={styles.sectionHeader}>
              <Ionicons name="trophy-outline" size={24} color={themeColors.primary} />
              <Text style={[styles.sectionTitle, { color: themeColors.text }]}>Our Motto</Text>
            </View>
            ...
            <View
              ...
              <View style={styles.mottoGrid}>
                {mottoValues.map((value, index) => (
                  <View
                    style={[styles.mottoItem, { backgroundColor: themeColors.success + '10' }]}
                    key={index}>
                    <Ionicons name="checkmark-circle" size={16} color={themeColors.success} />
                    <Text style={[styles.mottoText, { color: themeColors.text }]}>{value}</Text>
                  </View>
                ))}
              </View>
            </View>
