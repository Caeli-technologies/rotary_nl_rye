      ...
      <ScrollView
        ...
        <View style={styles.content}>
          ...
          <View style={styles.headerSection}>
            ...
            <Text style={[styles.headerTitle, { color: themeColors.text }]}>Insurance</Text>
          ...
          <View style={styles.section}>
            <View
              ...
              <View style={styles.compulsoryHeader}>
                ...
                <Text style={[styles.compulsoryTitle, { color: themeColors.text }]}>
                  Compulsory Coverage
                </Text>
              </View>
              <Text style={[styles.compulsoryText, { color: themeColors.text }]}>
          ...
          <View style={styles.section}>
            ...
            <View
              ...
              <View style={styles.timelineItem}>
                <View style={[styles.timelineIcon, { backgroundColor: themeColors.background }]}>
                  <Ionicons name="airplane-outline" size={20} color={themeColors.info} />
                </View>
                <View style={styles.timelineContent}>
                  <Text style={[styles.timelineTitle, { color: themeColors.text }]}>
                    Arrival at Schiphol
                  </Text>
                  <Text style={[styles.timelineText, { color: themeColors.textSecondary }]}>
              ...
              <View style={styles.timelineItem}>
                <View style={[styles.timelineIcon, { backgroundColor: themeColors.background }]}>
                  <Ionicons name="calendar-outline" size={20} color={themeColors.success} />
                </View>
                <View style={styles.timelineContent}>
                  <Text style={[styles.timelineTitle, { color: themeColors.text }]}>
                    During Exchange
              ...
              <View style={styles.timelineItem}>
                <View style={[styles.timelineIcon, { backgroundColor: themeColors.background }]}>
                  <Ionicons name="home-outline" size={20} color={themeColors.warning} />
                </View>
                <View style={styles.timelineContent}>
                  <Text style={[styles.timelineTitle, { color: themeColors.text }]}>Departure</Text>
                  <Text style={[styles.timelineText, { color: themeColors.textSecondary }]}>
          ...
          <View style={styles.section}>
            ...
            <View
              ...
              <View style={styles.documentHeader}>
                <Ionicons name="mail-outline" size={20} color={themeColors.success} />
