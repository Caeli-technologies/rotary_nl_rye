				...
				<View style={styles.content}>
					...
					<View style={styles.section}>
						...
						>
							...
							>
								<Text
									style={[styles.goalNumberText, { color: themeColors.card }]}
								>
									1
								</Text>
							</View>
							<View style={styles.goalContent}>
								<Text style={[styles.goalText, { color: themeColors.text }]}>
									...
									Wij kunnen zó beter inschatten waar jullie als toekomstige
									Outbounds naar toe zouden kunnen gaan.
								</Text>
							</View>
						</View>
						...
						>
							...
							<View style={styles.goalContent}>
								<Text style={[styles.goalText, { color: themeColors.text }]}>
									...
									Je kunt laten zien dat je uit het goede
									&ldquo;uitwisselingshout&rdquo; bent gesneden. Aanwezigheid is
									verplicht. Het weekend is dan ook onderdeel van de
