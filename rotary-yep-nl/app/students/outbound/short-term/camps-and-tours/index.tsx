		...
		() => [
			{
				...
				route:
					"/outbound/short-term/camps-and-tours/information/how-to-sign-up",
				type: "info",
			},
			{
				...
				route:
					"/outbound/short-term/camps-and-tours/information/which-countries",
				type: "info",
			},
			{
				title: "Voor wie?",
		...
		() => (
			<View style={styles.introContainer}>
				...
				>
					...
					>
						Rotary Zomerkampen zijn kortdurende uitwisselingsprogramma&apos;s
						die meestal 2-6 weken duren tijdens schoolvakanties. Deze
						programma&apos;s bieden jongeren de mogelijkheid om verschillende
						culturen te ervaren, internationale vriendschappen te sluiten en
						deel te nemen aan spannende activiteiten terwijl ze verblijven bij
						gastgezinnen of in georganiseerde accommodaties.
					</Text>
				</View>
