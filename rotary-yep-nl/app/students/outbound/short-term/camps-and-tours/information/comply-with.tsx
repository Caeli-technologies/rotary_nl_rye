					...
					<View style={styles.section}>
						...
						>
							...
							<View style={styles.ageContent}>
								<Text style={[styles.ageTitle, { color: themeColors.primary }]}>
									15 - 21 jaar
								</Text>
								<Text
									style={[
					...
					<View style={styles.section}>
						...
						>
							...
							<View style={styles.expectationContent}>
								<Text
									style={[styles.expectationTitle, { color: themeColors.text }]}
								>
									Internationale Ervaring
								</Text>
								<Text
									style={[
										styles.expectationDescription,
										{ color: themeColors.textSecondary },
									]}
								>
