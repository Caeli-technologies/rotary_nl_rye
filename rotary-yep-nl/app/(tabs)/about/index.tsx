			...
			>
				<View style={styles.content}>
					...
					>
						...
						<Text
							style={[styles.cardText, { color: themeColors.textSecondary }]}
						>
					...
					>
						...
						<Text
							style={[styles.cardText, { color: themeColors.textSecondary }]}
						>
							Rotary Youth Exchange biedt jongeren de kans om een jaar (of
							kortere periode) in het buitenland te wonen, studeren en een
							nieuwe cultuur te ontdekken. Het programma stimuleert:
						</Text>
						<View style={styles.listItemContainer}>
							...
							>
								Internationaal begrip en vrede door jongeren wereldwijd met
								elkaar te verbinden
							</Text>
						</View>
						<View style={styles.listItemContainer}>
							...
							>
								...
								laten stappen, zelfstandig te worden en zich aan te passen aan
								een nieuwe omgeving
							</Text>
						</View>
						<View style={styles.listItemContainer}>
					...
					>
						...
						<View style={styles.listItemContainer}>
							...
							>
								Short term 2x2 weken (Noordelijk Halfrond) of 4x4 weken
								(Zuidelijk Halfrond)
							</Text>
						</View>
						<View style={styles.listItemContainer}>
