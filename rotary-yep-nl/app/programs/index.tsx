		...
		() => (
			<View style={styles.introContainer}>
				...
				<Text style={[styles.introText, { color: themeColors.textSecondary }]}>
					Ontdek alle uitwisselingsprogramma&apos;s die Rotary YEP Nederland
					aanbiedt. Van lange termijn jaaruitwisselingen tot korte
					zomerprogramma&apos;s en promotioneel materiaal.
				</Text>
			</View>
		),
