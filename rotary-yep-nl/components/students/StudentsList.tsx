...
import type { Student, CountryGroup, StudentType } from "@/types/student";
			...
			>
				<View style={styles.sectionHeaderContent}>
					{flagAsset ? (
						...
						>
							<Text
								style={[styles.flagText, { color: themeColors.textSecondary }]}
							>
				...
				<Text
					style={[styles.sectionCount, { color: themeColors.textSecondary }]}
				>
