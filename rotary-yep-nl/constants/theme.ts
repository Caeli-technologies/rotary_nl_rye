 ...
 *
 * This color system supports both light and dark modes while maintaining
 * Rotary's brand identity across all communications.
 */
...
export const Colors = {
  light: {
    ...
    textSecondary: '#3C3C43', // 70% opacity equivalent
    textTertiary: '#8E8E93', // iOS system gray
    textDisabled: '#C7C7CC',
  ...
  dark: {
    ...
    primary: RotaryColors.skyBlue, // Lighter blue for better contrast
    primaryVariant: RotaryColors.azure,
    secondary: RotaryColors.gold,
    ...
    backgroundElevated: '#1C1C1E', // iOS elevated background
    card: '#1C1C1E',
    surface: '#1C1C1E',
    ...
    textSecondary: '#EBEBF5', // 92% opacity equivalent
    textTertiary: '#8E8E93', // iOS system gray
    textDisabled: '#636366',
    onPrimary: RotaryColors.white,
    onSecondary: RotaryColors.black,
    ...
    linkVisited: '#BF5AF2', // Brighter purple
