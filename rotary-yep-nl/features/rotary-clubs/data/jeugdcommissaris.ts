...
export const jeugdcommissarisContent: SectionPageContent = {
  ...
  documents: [
    ...
    {
      id: "verklaring-jeugd-vrijwilliger",
    ...
    {
      id: "presentielijst-djc-training",
    ...
    {
      id: "voor-middelbare-scholen",
      title: "Voor Middelbare Scholen",
      icon: "school",
      pdfUrl:
